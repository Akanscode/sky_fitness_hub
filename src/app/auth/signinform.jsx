        ...
        <>
            ...
            <div className='w-full max-w-md  p-8 space-y-3 rounded-xl bg-white  '>
                ...
                <div className="text-sm text-center text-stone-600 capitalize">Don't have an account?
                    <Link href="" onClick={handleSignupClick} className="text-status-purple-50 font-medium text-sm pl-2">Sign Up </Link>
                </div>
                <div className="my-5">
                ...
                >
                    <Form className='space-y-2'>
                        ...
                        <div className='flex justify-end items-end'>
                            <Link href="#" onClick={handleForgetPasswordClick} className='-mr-3 w-max p-3'>
                                <span className='text-sm tracking-wide font-bold text-status-purple-40 capitalize'>forget password ?</span>
                            </Link>
                        </div>
                        <button type="submit" className="w-full py-4 bg-status-purple-60 hover:bg-status-purple-70 rounded-md text-md font-bold text-status-stone-30 transition duration-200">Login</button>
                    </Form>
                </Formik>
                </div>
                 )}
