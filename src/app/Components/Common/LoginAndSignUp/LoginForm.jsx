...
const LoginForm = ({ onSubmit }) => {
    return (
        <div className='w-full max-w-md absolute p-8 space-y-3 rounded-xl bg-white '>
            <h3 className='mb-3 text-center text-stone-800'>Login to your account</h3>
            <div className="text-sm text-center text-stone-600">Already have an account?
                <Link href="#" className="text-status-purple-50 font-medium text-sm pl-2">Sign up </Link>
            </div>
            <div className="my-5">
            ...
            >
                <Form className='space-y-2'>
                    ...
                    <div>
                        ...
                        <Field type="password" name="password" className="w-full p-4 text-sm bg-gray-50 focus:outline-none border border-gray-200 rounded-full" placeholder="Enter Password" />
                    ...
                    <div className='flex justify-end items-end'>
                        <button className='-mr-3 w-max p-3'>
                            <span className='text-sm tracking-wide text-status-purple-40 capitalize'>forget password ?</span>
                        </button>
                    </div>
