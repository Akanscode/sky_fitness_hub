...
import { groupclasses } from '../../Components/Data';
              ...
              <div className='mx-auto py-10 md:py-16'>
                  ...
                  <div className="lg:w-3/4 lg:mx-auto ">
                      {groupclasses.map((groupclass) => (
                          <div key={groupclass.id} className="group relative -mx-4 sm:-mx-8 p-6 sm:p-8 my-5 rounded-3xl bg-white border border-transparent hover:border-gray-100 shadow-2xl shadow-gray-400/10  hover:shadow-gray-600/10 sm:gap-8 sm:flex transition duration-300 hover:z-10">
                              <div className="sm:w-2/6 rounded-3xl overflow-hidden transition-all duration-500 group-hover:rounded-xl">
                                  <Image
                                      src={groupclass.postimage}
                                      alt="art cover"
                                      loading="lazy"
                                      width="1000"
                                      height="667"
                              ...
                              <div className="sm:p-2 sm:pl-0 sm:w-4/6">
                                  <div className='flex justify-between'>
                                      <div className='flex mt-4 mb-2 space-x-2'>
                                          <span className="  inline-block font-medium text-gray-400 bg-black px-2  sm:mt-0">{groupclass.mins}</span>
                                          <span className=" inline-block font-medium text-gray-400  sm:mt-0">{groupclass.timeandday}</span>
                                      </div>
                                      <span className='inline-block font-medium text-gray-400 sm:mt-0'>{groupclass.price }</span>
                                  </div>
                                  ...
                                  <div className="flex justify-between gap-4">
                                      <div className='inline-flex items-center'>
                                          <div className='w-50 h-50'>
                                              <Image src={groupclass.instructorimage} alt="instructorimage" width={25} height={25} className="rounded-full w-10 h-10" />
                                          </div>
                                          <span className=' pl-2 text-sm text-gray-900 font-extralight'>{groupclass.instructorname}</span>
                                      </div>
